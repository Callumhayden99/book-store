      ...
      >
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-gray-600 text-lg">
            ...
            also makes a positive impact on society. Over the years, we have
            grown into a trusted brand known for our quality service and
      ...
      >
        <div className="max-w-4xl mx-auto px-4">
          ...
          <ul className="list-disc list-inside text-lg text-white">
            <li className="mb-2">
              Local libraries and schools in need of books
            </li>
            <li className="mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-red-600 rounded-lg shadow-lg p-8 transform hover:scale-105 transition duration-300">
              ...
              <p className="text-white text-lg">
                ...
                customer service. We are always ready to assist you with any
            ...
            <div className="bg-red-600 rounded-lg shadow-lg p-8 transform hover:scale-105 transition duration-300">
              ...
              <p className="text-white text-lg">
                By shopping at BookBank, you are not only treating yourself to
                great books but also contributing to making a difference in the
                lives of others through our charitable initiatives.
              </p>
            </div>
            <div className="bg-red-600 rounded-lg shadow-lg p-8 transform hover:scale-105 transition duration-300">
              ...
              <p className="text-white text-lg">
                We take pride in offering a carefully curated selection of books
                and providing a seamless shopping experience. If you're not
      ...
      >
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-white text-lg mb-8">
            ...
            local organizations to promote literacy and education. If you would
            like to get involved or learn more about our charity work, please
